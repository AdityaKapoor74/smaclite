...
class Renderer:
    def __init__(self):
        ...
        self.writer = None  # Video writer for recording

        self.start_recording()

    def start_recording(self, filename='gameplay.mp4'):
        # Start recording to a file
        self.writer = imageio.get_writer(filename, fps=30)
    ...
    def render(self, map_info: MapInfo, units: List[Unit]):
        ...
        if self.writer is not None:
            ...
            frame = np.transpose(frame, (1, 0, 2))  # Transpose to correct the orientation
